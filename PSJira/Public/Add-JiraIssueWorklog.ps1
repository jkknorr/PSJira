function Add-JiraIssueWorklog
{
    ...
    .EXAMPLE
       Add-JiraIssueWorklog -Comment "Test comment" -Issue "TEST-001" -TimeSpent (New-Timespan -Seconds 60) -DateStarted (Get-Date)
       This example adds a simple worklog item to the issue TEST-001.
    .EXAMPLE
       Get-JiraIssue "TEST-002" | Add-JiraIssueWorklog "Test worklog item from PowerShell" -TimeSpent (New-Timespan -Seconds 60) -DateStarted (Get-Date)
    ...
    .EXAMPLE
       $c = Get-Process | Format-Jira
       Add-JiraIssueWorklog -Comment $c -Issue TEST-003 -TimeSpent 60 -DateStarted (Get-Date)
